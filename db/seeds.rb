...
puts "这个seeds文件可以自动建立一个admin账号，并且创建10个public jobs,以及10个hidden jobs"

create_account = User.create([email: 'yuziyao2007@163.com', password:'maple1983', password_confirmation: 'maple1983', is_admin: 'true'])
